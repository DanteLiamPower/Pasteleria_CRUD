 ...
 * @author PC
 */
public class registrar_compra_cliente extends javax.swing.JFrame {

    /**
     * Creates new form calculadora_pasteles
     */
    public registrar_compra_cliente() {
        initComponents();
        String a = "0";
    ...
    private void initComponents() {
        ...
        txtResultado.setBackground(new java.awt.Color(234, 242, 215));
        ...
        jButton2.setBackground(new java.awt.Color(234, 242, 215));
    ...
    public void calcularTodo() {
        ...
        txtResultado.setText(cmbTipo.getName());

    }

    public void verificacion_de_numeros_negativos() {

        double b = Double.parseDouble(txtResultado.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(registrar_compra_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new registrar_compra_cliente().setVisible(true);
            }
        });
    }
